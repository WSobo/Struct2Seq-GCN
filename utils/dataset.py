...
class Struct2SeqDataset(Dataset):
    ...
    def processed_file_names(self):
        return [f"data_{pdb_id}_v2.pt" for pdb_id in self.pdb_ids]
    ...
    def process(self):
        for pdb_id in self.pdb_ids:
            ...
            try:
                ...
                # Save processed data
                torch.save(data, os.path.join(self.processed_dir, f"data_{pdb_id}_v2.pt"))
    ...
    def get(self, idx):
        ...
        data = torch.load(os.path.join(self.processed_dir, f"data_{pdb_id}_v2.pt"), weights_only=False)
        return data
